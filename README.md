...
>geo_data:<br>
>. region: string,<br>
>. modern_country: string,<br>
>. ?modern_province: string,<br>
>. coordinates: latlon,<br>
>links: list[type: string, target: string]<br>
>labels: list[string]
...
>category: string,<br>
>labels: list[string],<br>
>raa: list[string, integer],<br>
>delegates: list[string, string],<br>
...
>id: string,<br>
>first_year: integer,<br>
>last_year: integer<br>
